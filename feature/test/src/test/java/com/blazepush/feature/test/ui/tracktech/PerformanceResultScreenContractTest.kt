...
class PerformanceResultScreenContractTest {
    ...
    companion object {
        ...
        private val REQUIRED_LITERALS = listOf(
            // Visual literals
            "R.string.detail_performance",
            "R.string.detail_test_type",
            "R.string.detail_date",
            "R.string.detail_device",
            "R.string.detail_distance_metric",
            "R.string.detail_time",
            "R.string.detail_peak_g",
            // round smooth-perftest-acceleration-curve §4：PEAK G 按 testTemplateId 二选一渲染
            "R.string.detail_peak_accel_g",
            "R.string.detail_peak_brake_g",
            "R.string.detail_legacy_record",
            "R.string.detail_avg_g",
            "R.string.records_speed_curve",
            "R.string.detail_g_force",
            "R.string.detail_speed_segments",
            "\"0-100 km/h\"",
            "\"100-0 km/h\"",
            // Chart 调用约束
            "wrapInCard = false",
