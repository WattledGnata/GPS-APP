...
/**
 * 首页 tab 入口 readiness condition enum，仅含 4 项 device/data 基础条件。
 *
 * 与 SmartTestLauncher 内 device condition 阈值对齐（BLE / data fresh / sats / hdop），
 ...
 *
 * @property canEnterTestFlow 4 项条件全满足才为 true
